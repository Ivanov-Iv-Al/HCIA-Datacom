...
-Пул интерфейса — это быстрое решение для обслуживания клиентов «здесь и сейчас» на конкретном порту. 
Глобальный пул — это профессиональный инструмент для централизованного управления IP-адресами во всей сети, включая удаленные офисы.
...
Если клиент подключен напрямую: Сервер берет IP-адрес своего интерфейса, на который пришел запрос, 
и ищет глобальный пул с такой же подсетью.
